...
/* v8.7.1: nar wrapper octagon + logo spin + 档案封存风 */
...
.mfrs-msg-narrative-wrapper::after {
  ...
  border-radius: 50% !important;
  filter: drop-shadow(0 0 6px rgba(212,68,58,0.7)) drop-shadow(0 0 2px rgba(0,0,0,0.6)) !important;
  background-color: rgba(48,10,8,0.55) !important;
  box-shadow: 0 0 10px rgba(178,58,50,0.45), inset 0 0 4px rgba(0,0,0,0.4) !important;
  pointer-events: none !important;
  transform-origin: center !important;
