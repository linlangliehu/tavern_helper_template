...
const databaseScriptUrl = 'https://testingcf.jsdelivr.net/gh/linlangliehu/tavern_helper_template@42d4b0437657a752fb8c7bc6917ebf0bc6603024/vendor/shujuku-sp-fork/index.js?v=phase153-4-0-final-baseline-6-28-p5-4-hotfix3';
const databaseScriptMarker = 'mfrs-4-0-final-baseline-6-28-p5-4-hotfix3';
