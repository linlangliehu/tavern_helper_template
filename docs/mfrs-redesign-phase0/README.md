...
## 进度（2026-07-13 · **8.13.17 已发** · BF2 源码完成待发）
...
| **BF2** C6/H4–H8/R*/RH*/RM* 协议·正则·发送 | **源码完成**（待 production dist + 发版） |

**一句话**：线上仍用 **8.13.17**；BF2 源码已合入工作区，发版后请重导新 PNG。
...
- 当前发布版：**8.13.17**（`…-v81317-h9-l1-pins` / `@21fecba`）  
  PNG：`src/神秘复苏模拟器发布版/神秘复苏模拟器发布版.png`  
- 回滚：8.13.16 `@91154c7…`（有 core mirror，无 H9/L1 pin）
