...
**一句话**：请重导 **8.13.12**（MVU 双保险 + 空回复恢复发送 + 线索别名/网关 warn-once）。
...
- 当前发布版：**8.13.12**（`…-v81312-p2-mvu-empty-send-crud`）  
  PNG：`src/神秘复苏模拟器发布版/神秘复苏模拟器发布版.png`  
- 回滚：8.13.11 `@55fbd27…`（无状态栏 MVU 回写 / 空回复恢复 / 线索别名）
