...
**一句话**：8.13.31 是当前已发布内容（MAINT-29 黄金储备 + drawer watcher 修复）。
...
- 当前发布内容：**8.13.31**（release `4c94a4e`；`v81331_20260716_01` / `@8ee8c584fc60`）
  - PNG：`src/神秘复苏模拟器发布版/神秘复苏模拟器发布版.png`
- 历史回滚点：8.13.29 `@95981c90c901`；8.13.22 `@158dcc29107f`；更近版本按 git tag/release 记录选择
