...
| **8.13.22** BF6 正则/清洗 + 发布链加固 | **元数据已准备；publish pending** → [RELEASE_8.13.22.md](./RELEASE_8.13.22.md) |

**一句话**：当前已发布为 **8.13.21**；8.13.22 元数据已准备，待 publish/PNG/最终门禁。
...
- 当前已发布版：**8.13.21**（`…-v81321-bf5-gates` / `@f2b7db2cab55`）
  - PNG：`src/神秘复苏模拟器发布版/神秘复苏模拟器发布版.png`
- 8.13.22 候选：`v81322_20260714_01` / `@158dcc29107f`（发布版 YAML/PNG 尚未生成）
- 回滚：8.13.21 `@f2b7db2cab55`
