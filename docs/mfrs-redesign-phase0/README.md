...
- 当前发布版：**8.13.0**（`@6996f0e…` / `…-v8130-ux-polish`）  
  PNG：`src/神秘复苏模拟器发布版/神秘复苏模拟器发布版.png`  
- 回滚：8.12.3 `@5b22070…` / `…-v8123-st-zfix`
