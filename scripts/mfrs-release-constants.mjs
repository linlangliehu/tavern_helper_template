...
// v8.15.17: MVU JSONPatch 写回修复——parseMessage fallback 到本地 JSONPatch + 幂等重试门禁
...
export const CDN_CACHE_VERSION = 'v81517_20260815_01';
export const RELEASE_VERSION = '8.15.17';
