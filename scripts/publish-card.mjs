...
const CDN_REF = 'e36f8aa';  // bot bundle，v8.5.9 MVU hotfix 协议兼容与同 ref vendor 链
const CDN = `https://testingcf.jsdelivr.net/gh/${REPO}@${CDN_REF}/`;
const CDN_CACHE_VERSION = 'phase164-4-0-final-baseline-6-28-p5-4-hotfix13-mvu-v859';
