...
// v8.13.14: C7 re-release — production dist + G1 freshness (dist @d5cd98f019f5)
const CDN_REF = 'd5cd98f019f53c00dc32ac4c909a914858cb962a';
const CDN = `https://testingcf.jsdelivr.net/gh/${REPO}@${CDN_REF}/`;
const CDN_CACHE_VERSION = 'phase168-4-0-final-baseline-6-28-p5-4-hotfix14-mvu-v81314-c7-dist-rebuild';
