...
const CDN_REF = '8b3ea67';  // bot bundle，v8.5.12 消息内面板最终渲染兜底
const CDN = `https://testingcf.jsdelivr.net/gh/${REPO}@${CDN_REF}/`;
const CDN_CACHE_VERSION = 'phase164-4-0-final-baseline-6-28-p5-4-hotfix13-mvu-v8512';
