...
const CDN_REF = '0717fc4';  // bot bundle，v8.5.14 跨角色卡污染清理
const CDN = `https://testingcf.jsdelivr.net/gh/${REPO}@${CDN_REF}/`;
const CDN_CACHE_VERSION = 'phase164-4-0-final-baseline-6-28-p5-4-hotfix13-mvu-v8514';
