...
const CDN_REF = 'c576add';  // bot bundle，v8.5.10 MVU verified writeback + persistence
const CDN = `https://testingcf.jsdelivr.net/gh/${REPO}@${CDN_REF}/`;
const CDN_CACHE_VERSION = 'phase164-4-0-final-baseline-6-28-p5-4-hotfix13-mvu-v8510';
