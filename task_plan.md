...
**当前待提交候选（2026-07-07 v8.5.8 planning 收口）：** 发布同步 commit `5b97c78` 已 push；当前只需提交 planning 三件套（`task_plan.md`、`progress.md`、`findings.md`）。`dist/**` 已由 bot bundle `454267e` 进入远端历史，不在 planning 提交中重复提交；`.tmp-mfrs-regex-backup-20260707.json` 与未跟踪截图 `屏幕截图 2026-07-06 235029.png` 不提交，除非用户明确要求保存为项目资产。
