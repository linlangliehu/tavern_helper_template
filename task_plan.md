...
**当前任务：v8.5.1 抽卡调查点按聊天隔离、数据库前端固定位置、抽卡写库双重去重已完成、发布并推送。**
...
2. 可选真页验证：导入 v8.5.1 后新建两个聊天，确认调查点分别从 0 开始且互不影响。
...
**当前无待提交发布同步文件（2026-07-05 v8.5.1 已 push）：** v8.5.1 source `5266dc5`、bot bundle `88fd7f1`、发布同步 `8a777c2` 已在 origin/main；发布同步包含 `scripts/publish-card.mjs`、`src/神秘复苏模拟器发布版/index.yaml`、`src/神秘复苏模拟器发布版/神秘复苏模拟器.png`、`src/神秘复苏模拟器发布版/神秘复苏模拟器发布版.png`。不要提交主工作区本地 `dist/**` 构建残留、`.tmp-*`、截图或参考卡文件。
