...
**当前无待提交发布同步文件（2026-07-06 v8.5.4 已 push）：** v8.5.4 发布同步提交 `7a997c2` 已在 origin/main；提交包含 `scripts/publish-card.mjs`、`src/神秘复苏模拟器发布版/index.yaml`、`src/神秘复苏模拟器发布版/神秘复苏模拟器.png`、`src/神秘复苏模拟器发布版/神秘复苏模拟器发布版.png`、`task_plan.md`、`progress.md`。不要提交主工作区本地 `dist/**` 构建残留、`.tmp-*`、截图、参考卡文件或 `.claude/worktrees/**`。P1 source commit `0acda89` 和 bot bundle `eef6274` 已在 origin/main。
